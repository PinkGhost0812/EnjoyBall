...
public class Team extends Model<Team>{
    ...
    public Team(Integer team_id, String team_name, String team_region, Date team_time, String team_logo, String team_slogan, Integer team_score, Integer team_captain, Integer team_state, Integer team_class, Integer team_number) {
        this.team_id = team_id;
        this.team_name = team_name;
        this.team_region = team_region;
        this.team_time = team_time;
